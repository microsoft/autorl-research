...
class PixelAugSacAgent(object):
    """Naive SAC with augmentation."""
    def __init__(
        self,
        obs_shape,
        action_shape,
    ...
    def update(self, replay_buffer, L, step):
        ...
        obs, action, reward, next_obs, not_done = replay_buffer.sample_aug(augmentation_type=self.augmentation_type)
