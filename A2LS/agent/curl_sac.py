...
class CurlSacAgent(object):
    ...
    def update(self, replay_buffer, L, step):
        if self.encoder_type == 'pixel':
            obs, action, reward, next_obs, not_done, cpc_kwargs = replay_buffer.sample_cpc(raw_state=False)

        elif self.encoder_type in ['mlp', 'ofe']:
            obs, action, reward, next_obs, not_done, cpc_kwargs = replay_buffer.sample_cpc(raw_state=True)
